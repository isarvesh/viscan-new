...
<head>
  ...
  <body id="scroll-top">
    ...
    <section class="page-header" style="background-image: url(images/background/bnr4.png);">
      <div class="overlay">
        <div class="container">
          <h3>T-Nagar Centre</h3>
          <ul>
            <li><a href="index.php">Home</a></li>
            <li>-</li>
            <li>T-Nagar Centre</li>
          </ul>
        </div><!-- container -->
      </div><!-- overlay -->
    </section><!-- page header -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
              <ul>
                <li class="contact-item">
                  ...
                  <div class="content">
                    <h4>Our Location</h4>
                    <p>46/29,CIT Nagar west,CIT Nagar ,Chennai,Tamil Nadu - 600035.</p>
                  </div>
                </li>
                <li class="contact-item">
                ...
                <li class="contact-item">
                  ...
                  <div class="content">
                    <h4>Email Address</h4>
                    <p> tnagar@viscandiagnostics.com</p>
                  </div>
                </li>
              </ul>
            </div>
			...
			<div style="color:#ffb606;font-weight:bold; " > </div>
               <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.0834254311976!2d80.22778011413574!3d13.030359217113482!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a52674060dc7575%3A0x76d0f340be42b374!2sVi-Scan%20Diagnostics%20T-Nagar%2C%20Chennai%20(Dental%20-%20CBCT%20%7C%20OPG)!5e0!3m2!1sen!2sin!4v1625820504776!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
          </div>
          </div><!-- row -->
        </div><!-- container -->
      </div><!-- contact-details -->
