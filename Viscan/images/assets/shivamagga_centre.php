...
<head>
  ...
  <body id="scroll-top">
    ...
    <section class="page-header" style="background-image: url(images/background/bnr4.png);">
      <div class="overlay">
        <div class="container">
          <h3>Shivamogga Centre</h3>
          <ul>
            <li><a href="index.php">Home</a></li>
            <li>-</li>
            <li>Shivamogga Centre</li>
          </ul>
        </div><!-- container -->
      </div><!-- overlay -->
    </section><!-- page header -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
              <ul>
                <li class="contact-item">
                  ...
                  <div class="content">
                    <h4>Our Location</h4>
                    <p>SR complex, JPN Road, Mission Compound, Shivamogga - 577201.</p>
                  </div>
                </li>
                <li class="contact-item">
                ...
                <li class="contact-item">
                  ...
                  <div class="content">
                    <h4>Email Address</h4>
                    <p> shivamogga@viscandiagnostics.com</p>
                  </div>
                </li>
              </ul>
            </div>
			...
			<div style="color:#ffb606;font-weight:bold; " > </div>
             <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15489.644890678932!2d75.5700147!3d13.9341033!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb21b7cf8ab6a1a7d!2sVi-scan%20Diagnostics%20(Shivamogga)!5e0!3m2!1sen!2sin!4v1633344296099!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
          </div>
          </div><!-- row -->
        </div><!-- container -->
      </div><!-- contact-details -->
