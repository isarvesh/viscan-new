...
<?php
	...
	$headers = "From:".$email."\r\n"."CC: admin@viscandiagnostics.com,operations@viscandiagnostics.com,connect@viscandiagnostics.com,dr.shilika@viscandiagnostics.com,webdeveloper@chesadentalcare.com";
