...
<head>
    ...
    <title>Andheri West Centre</title>
  ...
  <body id="scroll-top">
    ...
    <section class="page-header" style="background-image: url(images/background/bnr4.png);">
      <div class="overlay">
        <div class="container">
          <h3>Andheri West Centre</h3>
          <ul>
            <li><a href="index.php">Home</a></li>
            <li>-</li>
            <li>Andheri West Centre</li>
          </ul>
        </div><!-- container -->
      </div><!-- overlay -->
    </section><!-- page header -->
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
              <ul>
                <li class="contact-item">
                  ...
                  <div class="content">
                    <h4>Our Location</h4>
                    <p>Shop A-3, Versova Vinayak tower building, CHS, S.V.P Nagar, Near Mhada telephone exchange,
...
Mumbai, Maharashtra 400053</p>
                ...
                <li class="contact-item">
                  ...
                  <div class="content">
                    <h4>Email Address</h4>
                    <p> andheriwest@viscandiagnostics.com</p>
                  </div>
                </li>
              </ul>
            </div>
           ...
           <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d5330.649335607275!2d72.8200327955559!3d19.136663627132794!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xefa1f29374bab380!2sVi-Scan%20Diagnostics%20Andheri%20(W)%2C%20Mumbai%20(Dental%20-%20CBCT%20%7C%20OPG)!5e0!3m2!1sen!2sin!4v1633343392894!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
          </div><!-- row -->
        </div><!-- container -->
      </div><!-- contact-details -->
