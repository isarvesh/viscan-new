...
<head>
  ...
  <body id="scroll-top">
    ...
    <section class="page-header" style="background-image: url(images/background/bnr4.png);">
      <div class="overlay">
        <div class="container">
          <h3>Bangalore Centre</h3>
          <ul>
            <li><a href="index.php">Home</a></li>
            <li>-</li>
            <li>Bangalore Centre</li>
          </ul>
        </div><!-- container -->
      </div><!-- overlay -->
    </section><!-- page header -->
        ...
        <div class="container">
          <div class="row">
			...
			<div style="color:#ffb606;font-weight:bold; " > </div>
              <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15555.704952253805!2d77.6362847!3d12.9124623!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xf71033550ff360fd!2sVi-Scan%20Diagnostics%20HSR%20(Dental%20-%20CBCT%20%7C%20OPG%20%7C%20Diagnostics)!5e0!3m2!1sen!2sin!4v1631105141263!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
          </div><!-- row -->
        </div><!-- container -->
      </div><!-- contact-details -->
